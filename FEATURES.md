...
- Core dialer, T9 contacts, Recents, Favorites, multi-SIM routing and in-call controls.
...
- Caller announcements, voice controls, video transition and conferencing.
...
- Glaze UI and first-class accessibility.
