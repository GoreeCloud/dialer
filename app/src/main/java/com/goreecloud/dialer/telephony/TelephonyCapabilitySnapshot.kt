...
data class TelephonyCapabilitySnapshot(
    ...
    val wifiCallingState: CapabilityState,
    val supplementaryServices: CapabilityState,
    ...
    companion object {
        fun developmentPlaceholder() = TelephonyCapabilitySnapshot(
            ...
            multiSimRouting = CapabilityState.Unavailable("Phone-account routing not implemented"),
            wifiCallingState = CapabilityState.Unavailable("Wi-Fi Calling state observation not implemented"),
            supplementaryServices = CapabilityState.Unavailable("Supplementary-service observation not implemented"),
