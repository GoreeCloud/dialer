...
4. Instrumentation-test APK compilation: `:app:assembleDebugAndroidTest`
...
These require independent evidence and must not be inferred from CI compilation or JVM-test success.
