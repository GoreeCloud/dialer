...
- Verified stabilization base for this reconciliation: `main` at `38f5655570956a9125a53380f0831792272a372b`.
...
- Android CI is being reconciled to immutable third-party action revisions, Ubuntu 24.04, exact-source checkout verification, and non-persisted checkout credentials. These are Development supply-chain controls and do not substitute for issue #14 physical-device/carrier acceptance.
